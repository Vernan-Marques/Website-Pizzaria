...
$('section#domingo-perfeito').waypoint( function (direcao) {
    ...
    if (direcao == "down") {
        $('div.folha1').addClass('animate__animated animate__fadeInUp'); //Velocidade padrao
        $('div.folha3').addClass('animate__animated animate__fadeInUp');
        $('div.camarao').addClass('animate__animated animate__fadeInUp animate__slow'); //Velocidade Lento
        $('div.tomate').addClass('animate__animated animate__fadeInUp animate__slow');
        $('div.queijo').addClass('animate__animated animate__fadeInUp animate__slower'); //Velocidade mais lento
...
/* Codigos de Animacao - Seção pizza*/
...
/* Codigos de Animacao - Secao Dopoimentos*/
...
/*Identificando o tamanho da janela*/
